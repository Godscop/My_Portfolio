...
CSN 1101, Assignment 1: a personal portfolio site built with semantic HTML5
and an external stylesheet — a home page and a projects catalogue page.

## What's here
- `index.html` — home page: hero, about, toolkit, and contact sections
- `projects.html` — projects catalogue page
